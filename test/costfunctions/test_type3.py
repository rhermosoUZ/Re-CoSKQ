...
class TestType3(TestCase):
    def test_instantiation(self):
        t3 = Type3(euclidean_distance, keyword_distance, 0.3, 0.3, 0.4, 0.5, 0.6, 0.7, False)
    ...
    def test_solve1(self):
        t3 = Type3(euclidean_distance, keyword_distance, 1, 0, 0, disable_thresholds=True)
    ...
    def test_solve2(self):
        t3 = Type3(euclidean_distance, keyword_distance, 0, 1, 0, disable_thresholds=True)
        keywords_query = ['food', 'fun', 'outdoor', 'family']
        keywords_kwc1 = ['food', 'fun', 'outdoor']
        keywords_kwc2 = ['food', 'fun']
        keywords_kwc3 = ['food']
    ...
    def test_solve3(self):
        t3 = Type3(euclidean_distance, keyword_distance, 0, 0, 1, disable_thresholds=True)
        keywords_query = ['food', 'fun', 'outdoor', 'family']
        keywords_kwc1 = ['food', 'fun', 'outdoor']
        keywords_kwc2 = ['food', 'fun']
        keywords_kwc3 = ['food']
    ...
    def test_solve4(self):
        t3 = Type3(manhattan_distance, keyword_distance, 1, 0, 0, disable_thresholds=True)
        keywords_query = ['food', 'fun', 'outdoor', 'family']
        keywords_kwc1 = ['food', 'fun', 'outdoor']
        keywords_kwc2 = ['food', 'fun']
        keywords_kwc3 = ['food']
    ...
    def test_solve5(self):
        t3 = Type3(manhattan_distance, keyword_distance, 0, 1, 0, disable_thresholds=True)
        keywords_query = ['food', 'fun', 'outdoor', 'family']
        keywords_kwc1 = ['food', 'fun', 'outdoor']
        keywords_kwc2 = ['food', 'fun']
        keywords_kwc3 = ['food']
    ...
    def test_solve6(self):
        t3 = Type3(manhattan_distance, keyword_distance, 0, 0, 1, disable_thresholds=True)
        keywords_query = ['food', 'fun', 'outdoor', 'family']
        keywords_kwc1 = ['food', 'fun', 'outdoor']
        keywords_kwc2 = ['food', 'fun']
        keywords_kwc3 = ['food']
    ...
    def test_solve7(self):
        t3 = Type3(euclidean_distance, keyword_distance, 0.3, 0.3, 0.4, disable_thresholds=True)
        keywords_query = ['food', 'fun', 'outdoor', 'family']
        keywords_kwc1 = ['food', 'fun', 'outdoor']
        keywords_kwc2 = ['food', 'fun']
        keywords_kwc3 = ['food']
    ...
    def test_solve8(self):
        t3 = Type3(manhattan_distance, keyword_distance, 0.3, 0.3, 0.4, disable_thresholds=True)
        keywords_query = ['food', 'fun', 'outdoor', 'family']
        keywords_kwc1 = ['food', 'fun', 'outdoor']
        keywords_kwc2 = ['food', 'fun']
        keywords_kwc3 = ['food']
    ...
    def test_threshold1(self):
        t3 = Type3(euclidean_distance, keyword_distance, 0.3, 0.3, 0.4, 0.2, math.inf, math.inf)
    ...
    def test_threshold2(self):
        t3 = Type3(euclidean_distance, keyword_distance, 0.3, 0.3, 0.4, 0.1, math.inf, math.inf)
        query = KeywordCoordinate(0, 0, ['keyword1', 'keyword2', 'keyword3'])
        kwc1 = KeywordCoordinate(0.1, 0.1, ['keyword1', 'keyword2', 'keyword3'])
        kwc2 = KeywordCoordinate(0.1, 0.1, ['keyword1', 'keyword2', 'keyword3'])
        data = [kwc1, kwc2]
    ...
    def test_threshold3(self):
        t3 = Type3(euclidean_distance, keyword_distance, 0.0, 0.3, 0.7, math.inf, 0.2, math.inf)
        query = KeywordCoordinate(0, 0, ['keyword1', 'keyword2', 'keyword3'])
        kwc1 = KeywordCoordinate(0.1, 0.1, ['keyword1', 'keyword2', 'keyword3'])
    ...
    def test_threshold4(self):
        t3 = Type3(euclidean_distance, keyword_distance, 0.0, 0.3, 0.7, math.inf, 0.1, math.inf)
        query = KeywordCoordinate(0, 0, ['keyword1', 'keyword2', 'keyword3'])
        kwc1 = KeywordCoordinate(0.1, 0.1, ['keyword1', 'keyword2', 'keyword3'])
        kwc2 = KeywordCoordinate(0.2, 0.2, ['keyword1', 'keyword2', 'keyword3'])
        data = [kwc1, kwc2]
    ...
    def test_threshold5(self):
        t3 = Type3(euclidean_distance, keyword_distance, 0.25, 0.25, 0.5, math.inf, math.inf, 0.5)
        query = KeywordCoordinate(0, 0, ['keyword1', 'keyword2', 'keyword3'])
    ...
    def test_threshold6(self):
        t3 = Type3(euclidean_distance, keyword_distance, 0.25, 0.25, 0.5, math.inf, math.inf, 0.4)
        query = KeywordCoordinate(0, 0, ['keyword1', 'keyword2', 'keyword3'])
        kwc1 = KeywordCoordinate(0, 0, ['keyword1'])
        kwc2 = KeywordCoordinate(0, 0, ['keyword2'])
        data = [kwc1, kwc2]
